...
public class RequestLoggerTest extends TestCase {
    ...
    public void testLogRequest() {
        logger.logRequestCompleted("testPath" ,"test URL", 100L, false);
        sleep();
    }
    ...
    public void testLogExternalSystemUsageSimple() {
        ...
        logger.logRequestCompleted("testPath" ,"test URL with Mongo", 100L, false);
        logger.logRequestCompleted("testPath" ,"test URL without Mongo", 50L, false);
        sleep();
    }
